...
public class QueryingDAO {
    ...
    public Customer findCustomerById(Long id) {
        ...
        return jdbcTemplate.queryForObject(sql, (result, count) -> new Customer(
                result.getString("first_name"),
                result.getString("last_name")), id);
    }
    ...
    public List<Customer> findAllCustomers() {
        ...
        return jdbcTemplate.query(sql, (result, count) ->
                new Customer(result.getString("first_name"),
    ...
    public List<Customer> findCustomerByFirstName(String firstName) {
        ...
        return jdbcTemplate.query(sql, (result, count) ->
                new Customer(result.getString("first_name"),
                        result.getString("last_name")), firstName);
    }
}
